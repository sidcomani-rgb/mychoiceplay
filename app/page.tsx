    ...
    <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center gap-8 p-5">
      ...
      <div className="bg-zinc-900 p-8 rounded-3xl border border-pink-500 text-center w-full max-w-md">
        ...
        <button
          ...
          className="mt-8 bg-green-500 px-8 py-4 rounded-full font-bold text-black w-full"
        >
          ADD BALANCE
        </button>
        ...
        <button
          ...
          className="mt-4 bg-pink-500 px-8 py-4 rounded-full font-bold text-white w-full"
        >
          WITHDRAW
        </button>
      </div>
